...
public:
	...
	*/
	...
	static Datum vecNative(vector<Datum> args);

	// Returns the upper bound of the array
	static Datum vecBoundNative(vector<Datum> args);

	// Returns the element at the given index
	static Datum vecGetNative(vector<Datum> args);

	// Retruns the length of the array
	static Datum vecLengthNative(vector<Datum> args);
	
	// Returns a subset of an array
	static Datum vecSubNative(vector<Datum> args);	
